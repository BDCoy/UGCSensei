...
export const CallToActionSection = (): JSX.Element => {
  ...
  return (
    <section className="w-full mt-10 mx-auto px-4 sm:px-6 lg:px-8">
      {/* Heading */}
      <div className="pt-24 pb-12 text-center max-w-[800px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14">
        {cards.map((card, idx) => (
          <div
            key={idx}
            className="flex flex-col gap-4 p-6 md:p-8 bg-[#eff3ff] rounded-2xl shadow-[3px_3px_10px_rgba(0,0,0,0.1)]"
          >
